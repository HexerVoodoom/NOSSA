# Perguntas de Competências (Afirmações Técnicas)

Lista completa das **afirmações técnicas** (fluxo de Avaliação Tradicional, `evaluationType: "tradicional"`, `type: "statement"`) usadas na Arquitetura de Carreira, organizadas por competência e categoria. Cada afirmação herda as tags de cargo (`associado`/`liderança`) da sua competência — são essas tags que determinam para quais cargos a afirmação é exibida no fluxo de avaliação.
...
**Competência:** `comp-b1-agilidade` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Auxiliar de Serviços Gerais
...
**Competência:** `comp-b1-capacidade-execucao` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Administrador, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Gestor de Obra
...
**Competência:** `comp-b1-organizacao` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Administrador, Auxiliar de Serviços Gerais, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Financeiro, Gerente Comercial, Gestor de Obra
...
**Competência:** `comp-b1-planejamento` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Administrador, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Financeiro, Gerente Comercial
...
**Competência:** `comp-b1-priorizacao` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b1-orientacao-resultado` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** 3D Manager
...
**Competência:** `comp-b1-atencao-concentrada` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Administrador, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Financeiro, Gestor de Obra
...
**Competência:** `comp-b1-detalhista` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Auxiliar de Serviços Gerais, Coordenadora de Projetos
...
**Competência:** `comp-b2-raciocinio-logico` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Desenvolvedor de Projetos Executivos
...
**Competência:** `comp-b2-raciocinio-abstrato` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Desenvolvedor de Projetos Executivos
...
**Competência:** `comp-b2-capacidade-investigativa` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** 3D Manager, Coordenadora de Projetos
...
**Competência:** `comp-b2-senso-critico` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** Gestor de Obra
...
**Competência:** `comp-b2-resolucao-problemas` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Administrador, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Financeiro, Gerente Comercial, Gestor de Obra
...
**Competência:** `comp-b2-tomada-decisao` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Administrador, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Financeiro, Gerente Comercial, Gestor de Obra
...
**Competência:** `comp-b3-foco-cliente` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** Coordenadora de Projetos
...
**Competência:** `comp-b3-atencao-cliente` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** Gerente Comercial
...
**Competência:** `comp-b3-negociacao` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Financeiro, Gestor de Obra
...
**Competência:** `comp-b4-comunicacao` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Administrador, Auxiliar de Serviços Gerais, Desenvolvedor de Projetos Executivos, Financeiro
...
**Competência:** `comp-b4-trabalho-equipe` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Desenvolvedor de Projetos Executivos
...
**Competência:** `comp-b4-relacionamento-interpessoal` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Administrador, Auxiliar de Serviços Gerais, Coordenadora de Projetos, Financeiro, Gerente Comercial, Gestor de Obra
...
**Competência:** `comp-b4-cordialidade` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** Gerente Comercial
...
**Competência:** `comp-b4-empatia` &nbsp;·&nbsp; **Tags de cargo:** `liderança`
**Cargos padrão:** Coordenadora de Projetos
...
**Competência:** `comp-b4-resolucao-conflitos` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`

- `q-b4-rc-1` Escuta ativamente as perspectivas das pessoas envolvidas em conflitos.
- `q-b4-rc-2` Busca soluções práticas e eficazes para resolver conflitos.

### Disponibilidade (Interna)

**Competência:** `comp-b4-disponibilidade-interna` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b5-comprometimento` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Administrador, Auxiliar de Serviços Gerais, Financeiro, Gerente Comercial
...
**Competência:** `comp-b5-responsabilidade` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** Auxiliar de Serviços Gerais, Gerente Comercial
...
**Competência:** `comp-b5-comportamento-etico` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Auxiliar de Serviços Gerais, Financeiro
...
**Competência:** `comp-b5-confiabilidade` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Financeiro
...
**Competência:** `comp-b5-transparencia` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b5-sigilo` &nbsp;·&nbsp; **Tags de cargo:** `associado`
**Cargos padrão:** Financeiro
...
**Competência:** `comp-b6-aprendizado-continuo` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b6-adaptacao-mudancas` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`

- `q-b6-am-1` Adapta-se a mudanças com flexibilidade.
- `q-b6-am-2` Mantém desempenho mesmo diante de cenários novos ou incertos.

### Abertura ao Feedback

**Competência:** `comp-b6-abertura-feedback` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b6-autodesenvolvimento` &nbsp;·&nbsp; **Tags de cargo:** `associado` `liderança`
**Cargos padrão:** 3D Manager, Coordenadora de Projetos, Desenvolvedor de Projetos Executivos, Gerente Comercial, Gestor de Obra
...
**Competência:** `comp-b6-visao-futuro` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Competência:** `comp-b6-proatividade-desenvolvimento` &nbsp;·&nbsp; **Tags de cargo:** `sem cargo padrão vinculado`
...
**Total de afirmações técnicas:** 91
