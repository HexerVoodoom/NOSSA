...
export const DS = {
  typography: {
    ...
    // slate-400 sobre o fundo claro dá ~2.5:1 e reprova no AA. Estas legendas
    // carregam texto que precisa ser lido (estados vazios, dicas), não são
    // decoração.
    caption: "text-sm text-slate-600 font-medium italic",
  },
  buttons: {
  ...
  inputs: {
    // `outline-none` sozinho apagava o anel de foco do navegador sem repor
    // nada: quem navega por teclado não enxergava onde estava (WCAG 2.4.7).
    base: "w-full bg-slate-50 border border-slate-200 focus:border-slate-400 focus:bg-white rounded-2xl p-4 outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2 focus-visible:ring-offset-white transition-all text-sm text-slate-900 placeholder:text-slate-400 font-normal",
    label: "text-sm font-bold tracking-wider text-slate-600 ml-1 mb-2 block",
  },
  layout: {
